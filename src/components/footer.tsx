    ...
    <footer className="bg-primary text-primary-foreground py-16">
      <div className="container max-w-screen-xl mx-auto px-4 md:px-8 flex flex-col items-center justify-center">
        <div className="grid md:grid-cols-3 gap-10 w-full mb-8 ">
          ...
          <div className="flex flex-col justify-start items-start space-y-4">
            ...
            <p className="text-sm text-primary-foreground/80 text-left font-body">
              We are an independent escrow service provider working with licensed payment processors to ensure both buyers and sellers are happy with their transactions.
            </p>
            <div className="flex justify-start space-x-2 mt-2">
              <Button variant="ghost" size="icon" asChild className="bg-primary-foreground/10 hover:bg-primary-foreground/20 rounded-full">
                <a href="#">
          ...
          <div className="flex flex-col justify-start items-start space-y-3">
            ...
            <Link href="/why-mountescrow" className="block text-sm hover:underline text-primary-foreground/80 font-body">
              Why Mountescrow?
            </Link>
            <Link href="/how-it-works" className="block text-sm hover:underline text-primary-foreground/80 font-body">
              How It Works
            </Link>
            <Link href="/products" className="block text-sm hover:underline text-primary-foreground/80 font-body">
              Products
            </Link>
            <Link href="/dispute-resolution" className="block text-sm hover:underline text-primary-foreground/80 font-body">
              Dispute Resolution
            </Link>
          </div>
          ...
          <div className="flex flex-col justify-start items-start space-y-4">
            ...
            <p className="text-sm text-primary-foreground/80 font-body">
              Got enquiries or wanna make a suggestion? We are open and happy to hear from you.
            </p>
        ...
        <div className="border-t border-primary-foreground/20 w-full pt-8 mt-8">
            <p className="text-center text-sm text-primary-foreground/60">&copy; {new Date().getFullYear()} Mountescrow. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
