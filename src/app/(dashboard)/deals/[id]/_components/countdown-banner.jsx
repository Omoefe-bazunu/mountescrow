...
export function CountdownBanner({
        ...
        `/api/deals/${dealId}/milestones/${milestoneIndex}/auto-approve`,
        {
          ...
          headers: {
            ...
            Authorization: `Bearer ${
              process.env.NEXT_PUBLIC_AUTO_APPROVE_SECRET || ""
            }`,
          },
          credentials: "include",
        }
  ...
  // Show "on hold" state ONLY if:
  // 1. Countdown was cancelled
  // 2. Countdown is NOT currently active
  // 3. Status is STRICTLY "Submitted for Approval" (hides it if Completed/Rejected)
  if (
